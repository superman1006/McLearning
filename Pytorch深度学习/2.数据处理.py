...
# 单个图片的地址
img_path = "D:\\Project\\机器学习\\Pytorch深度学习\\hymenoptera_data\\train\\ants\\0013035.jpg"
img = Image.open(img_path)
print("img.size: ", img.size)

# ant 训练的数据集的地址
dataset_path = "D:\\Project\\机器学习\\Pytorch深度学习\\hymenoptera_data\\train"
label = "ants"
...
if __name__ == '__main__':
    root_dir = "D:\\Project\\机器学习\\Pytorch深度学习\\hymenoptera_data\\train"
    label_dir = "ants"
    # 创建数据集
